#ifndef UI_CHARACTERS_H
#define UI_CHARACTERS_H
namespace Tile {

constexpr uint8_t  ascii[] = { // 6
...
constexpr uint8_t note_letter[] = { // 4
  0x3C, 0x0A, 0x0A, 0x3C, // A
  0x1E, 0x28, 0x28, 0x38, // B
  0x3E, 0x22, 0x22, 0x36, // C
  0x3E, 0x22, 0x22, 0x1C, // D
  0x3E, 0x2A, 0x2A, 0x22, // E
  0x3E, 0x0A, 0x0A, 0x02, // F
  0x1C, 0x22, 0x2A, 0x3A  // G
};

constexpr uint8_t note_octave[] = { // 4
  0x3E, 0x22, 0x22, 0x3E, // 0
  0x00, 0x24, 0x3E, 0x20, // 1
  0x3A, 0x2A, 0x2A, 0x2E, // 2
  0x22, 0x2A, 0x2A, 0x3E, // 3
  0x0C, 0x08, 0x08, 0x3E, // 4
  0x2E, 0x2A, 0x2A, 0x3A, // 5
  0x3E, 0x2A, 0x2A, 0x38, // 6
  0x22, 0x12, 0x0A, 0x06, // 7
  0x3E, 0x2A, 0x2A, 0x3E, // 8
  0x0E, 0x0A, 0x0A, 0x3E // 9
};

constexpr uint8_t note_sharp[] = { 0x0E }; // sharp symbol (replace with 0x00 when neutral)

constexpr uint8_t cursor_arrow[] = { // 6
